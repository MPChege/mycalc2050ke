...
const BioEnergyInfoPage = () => {
  return (
    <>
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <title>Bio-Energy Info Page</title>
    ...
    <div id="section-1">
      ...
      >
        Bioenergy power is a renewable and carbon-neutral energy source,
        offering sustainability and emissions reduction in a diverse energy mix.
      </p>
      <div
    ...
    <div id="section-2">
      ...
      >
        This lever allows you to decide how much of Kenya's land area is used
        for bioenergy and how waste is managed, by setting an ambition level for
        bioenergy, from level 1 (minimum effort) to level 4 (maximum effort).
      </p>
    </div>
    <div id="section-3">
      <div
      ...
      >
        Biomass, including dedicated crops and waste materials, generates
        bioenergy for various purposes. Biofuels from biomass are important for
        hard-to-decarbonize transport like aviation, while bioenergy can fuel
        industry and produce biogas for the gas grid. Burning biomass is carbon
        neutral since the emitted CO<sub>2</sub> was previously absorbed by the
        crop. With carbon capture and storage (CCS), biomass combustion can even
        result in negative emissions, removing CO<sub>2</sub> from the
        atmosphere. However, biomass competes with food production and must be
        sustainably produced, limiting availability. My2050 prioritizes
        bioenergy with CCS for electricity generation and aviation fuel,
        considering it a valuable but limited resource.
      </p>
    </div>
    <div id="section-4">
      <div id="level-1">
    ...
    <div id="section-5">
      ...
      >
        Changing the amount of land used for bioenergy affects how much land can
        be used for Forestry. Replacing fossil fuels with bioenergy is an
        alternative to electrification as a method to reduce emissions in
...
export default BioEnergyInfoPage;
