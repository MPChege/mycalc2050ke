  ...
  return (
        ...
        <>
          ...
          <div id="main-content">
            ...
            >
              Ambition Level <span id="ambitionlevelinfo" />
            </p>
            <p
              id="traveldemandcontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "27.1vw",
            ...
            >
              By 2050 the average annual distance travelled per person is 10% less
              than in 2015. 38% of this is done by car.
            </p>
            <p
              style={{
                position: "absolute",
            ...
            >
              Ambition Level <span id="techambitionlevelinfo" />
            </p>
            <p
              id="techambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "40vw",
            ...
            >
              0% of cars are electric by 2050 (0% of vans and 0% of small trucks).
            </p>
            <p
              style={{
                position: "absolute",
            ...
            >
              Ambition Level <span id="heavyambitionlevelinfo" />
            </p>
            <p
              id="heavyambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "52.9vw",
            ...
            >
              0% of large trucks, 0% of buses and 65% of passenger trains are electric
              by 2050.
            </p>
            <img
              src="Assets/vehicles/Cars/electric-cars/BusSmallElectricA.png"
              style={{
                position: "absolute",
                width: "47vw",
                top: "63vw",
