  ...
  return (
        <>
          ...
          <div id="main-content">
            ...
            >
              Ambition Level <span id="houseambitionlevelinfo" />
            </p>
            <p
              id="houseambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "27.1vw",
            ...
            >
              Ambition Level <span id="lightingambitionlevelinfo" />
            </p>
            <p
              id="lightingambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "40vw",
            ...
            >
              By 2050, compared to 2015, domestic lighting demand per person is 50%
              higher and the same efficiency, appliance demand is 50% higher and the
              same efficiency.
            </p>
            <p
              style={{
            ...
            >
              Ambition Level <span id="hotwaterambitionlevelinfo" />
            </p>
            <p
              id="hotwaterambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "52.9vw",
            ...
            >
              ...
              installed, with most <br /> homes continuing to use boilers fuelled with
              gas from the gas grid.
            </p>
            <img
              src="Assets/Buildings-images/foreground-building-update.png"
              style={{
                position: "absolute",
                width: "100vw",
                top: "44.6vw",
