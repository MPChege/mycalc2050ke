...
const CarbonIntensityInfoPage = () => {
  return (
        <>
          <meta name="viewport" content="width=device-width, initial-scale=1.0" />
          <title>Carbon Intensity Info Page</title>
          ...
          <div id="section-1">
            ...
            >
              Reduce industrial carbon intensity by adopting energy-efficient
              technologies, incorporating renewables, and optimizing production
              processes for a more sustainable industry.
            </p>
            <div
          ...
          <div id="section-2">
            ...
            >
              This lever allows you to reduce the carbon intensity of industry through
              improved energy efficiency and increased electrification by setting an
              ambition level for decarbonisation of industry by 2050, ranging from
              level 1 (minimum effort) to level 4 (maximum effort).
            </p>
          </div>
          <div id="section-3">
            <div
            ...
            >
              Industrial processes like metal production, cement manufacturing, and
              oil refining rely on fossil fuel-generated heat, causing greenhouse gas
              emissions. Energy efficiency measures, like optimized production
              scheduling, can reduce energy consumption. Switching fuels to low-carbon
              alternatives such as electricity, sustainable biomass, or low
              carbon-produced hydrogen lowers the carbon intensity of the industry. If
              fossil fuels continue to be used, carbon capture is necessary to curb
              emissions.
            </p>
          </div>
          <div id="section-4">
            <div id="level-1">
              ...
              >
                By 2050, 39% of heat generated in industry is from electricity.
                Industry energy efficiency improves by 10% relative to 2015.
              </p>
            </div>
            <div id="level-2">
              <img
              ...
              >
                By 2050, 50% of heat generated in industry is from electricity.
                Industry energy efficiency improves by 20% relative to 2015.
              </p>
            </div>
            <div id="level-3">
              <img
              ...
              >
                By 2050, 70% of heat generated in industry is from electricity.
                Industry energy efficiency improves by 30% relative to 2015.
              </p>
            </div>
            <div id="level-4">
              <img
              ...
              >
                By 2050, 99% of heat generated in industry is from electricity.
                Industry energy efficiency improves by 40% relative to 2015.
              </p>
            </div>
          </div>
          <div id="section-5">
            ...
            >
              Industry emissions can be captured using the Carbon Capture lever. High
              levels of industrial electrification require more low-carbon
              electricity, which needs to be generated using the Electricity levers
              for nuclear and renewables. Emissions can also be reduced by
              decarbonising the gas supply using the Hydrogen lever.
            </p>
          </div>
        </>
      )
...
export default CarbonIntensityInfoPage;
