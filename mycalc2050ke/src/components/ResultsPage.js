...
const ResultsPage = () => {
    ...
    return (
            <>
              ...
              >
                These graphs show the emissions and the emission reductions in 2050 as a
                result of your scenario, compared to the emission levels in 2015 <br />{" "}
                (the official reference year for emissions) and the reference scenario (in
                which all levers are set at level 1).
              </p>
              <div
