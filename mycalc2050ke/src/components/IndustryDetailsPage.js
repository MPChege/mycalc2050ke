  ...
  return (
        ...
        <>
          ...
          <div id="main-content">
            ...
            >
              Industry, CCS &amp; Hydroelectric power
            </p>
            <p
              style={{
                position: "absolute",
            ...
            >
              Ambition Level <span id="carbonIntensityambitionlevelinfo" />
            </p>
            <p
              id="carbonintensityambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "27.1vw",
            ...
            >
              10% decrease to 10% decrease in energy consumption and no change in
              process emissions, per unit of output <br /> by 2050
            </p>
            <p
              style={{
                position: "absolute",
            ...
            >
              Ambition Level <span id="carboncaptureambitionlevelinfo" />
            </p>
            <p
              id="carboncaptureambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "40vw",
            ...
            >
              0% to 85% capture rate range for CCS processes by 2070.
            </p>
            <p
              style={{
                position: "absolute",
            ...
            >
              Ambition Level <span id="hepambitionlevelinfo" />
            </p>
            <p
              id="hepambitionlevelinfocontent"
              style={{
                position: "absolute",
                left: "24.3vw",
                top: "52.9vw",
            ...
            >
              0.698 GW capacity by 2050 (0 GW in 2015) capable of generating up to 5
              TWh per year.
            </p>
            <img
              src="Assets/vehicles/Factory.png"
              style={{
                position: "absolute",
                width: "55vw",
                top: "60vw",
